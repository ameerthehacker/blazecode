...
// taken from https://github.dev/thesoftwarephilosopher/vanillajsx.com/blob/main/site/token-provider.ts to support jsx highlight
export const tsTokenProvider = {
